...
class PointResNet34V3(nn.Module):
    """
    ...
    def __init__(self, block= BasicBlock, layers=[6,6,3,1], in_channels = 64, zero_init_residual=False,
                 ...
                 norm_layer=None, name="PointResNet34V3", first_max_pool = False, freeze_layers = False, **kwargs):
        super(PointResNet34V3, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
    ...
    def _forward_impl(self, x):
        ...
        return [stage_4_out, stage_3_out, stage_2_out, stage_1_out]
